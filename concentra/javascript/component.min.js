...
q.printArea.append(q.printArray[w]);q.printArea.printArea({onReady:q.hidePrintLoading.bind(q)})}x.jumpToEnd()}})};e=BookInfo.getBook().pageWidth;f=BookInfo.getBook().pageHeight;g={};for(k=0;k<a.length;g={$jscomp$loop$prop$page$7:g.$jscomp$loop$prop$page$7},k++)g.$jscomp$loop$prop$page$7=a[k],getPageDir(g.$jscomp$loop$prop$page$7,"normal").then(function(l){return function(m){var n=e,p=f;if(bookConfig.normalSuffix&&"zip"===bookConfig.normalSuffix||-1<m.indexOf("zip"))window.printLoadStack||b.initPrintStack(a),
n=2*e,p=2*f;"object"!=typeof m&&m.match(/none/)?b.getPrintImgType(l.$jscomp$loop$prop$page$7).then(function(q){pageResourceLoad(l.$jscomp$loop$prop$page$7,q,d.bind(b),n,p)}):pageResourceLoad(l.$jscomp$loop$prop$page$7,"normal",d.bind(b),n,p)}}(g));h.jumpToEnd()})},createCompositeImage:function(a,b){var c=this;return new Promise(function(d,e){try{var f=document.createElement("canvas"),g=f.getContext("2d"),k=new Image;k.crossOrigin="anonymous";k.onload=function(){var h,l,m,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==
p.nextAddress)return p.setCatchFinallyBlocks(2),f.width=k.naturalWidth,f.height=k.naturalHeight,g.drawImage(k,0,0),p.yield(c.createWatermarkWithPageWatermark(k.naturalWidth,k.naturalHeight),4);if(2!=p.nextAddress)return(h=p.yieldResult)?g.drawImage(h,0,0):console.log("watermarkCanvas error"),l=f.toDataURL("image/png"),m=document.createElement("img"),m.src=l,m.style.cssText=a[0].style.cssText,d(m),p.leaveTryBlock(0);n=p.enterCatchBlock();console.error("canvas error:",n);d(null);p.jumpToEnd()})};k.onerror=
function(){console.log("img.onerror:",b);d(null)};k.src=b}catch(h){console.log("createCompositeImage error:",h),d(null)}})},createWatermarkWithPageWatermark:function(a,b){return new Promise(function(c){if(parseBool(bookConfig.PrintButtonVisible)&&bookConfig.printWatermark)try{var d=document.createElement("canvas");d.width=a;d.height=b;var e=new WatermarkCore(d),f=BookInfo.getBook().pageWidth,g=BookInfo.getBook().pageHeight,k=Math.min(a/f,b/g),h={position:bookConfig.watermarkPosition,width:(bookConfig.watermarkWidth||
...
getLanguage("frmPrintRange","Print Range")+"\n          </label>\n          <input id='print_range_num' placeholder='"+getLanguage("frmPrintexample","Example:1,3-7,12")+"'>\n        </div>\n      "));this.printAll.find(".print-all-main").css({display:"flex",alignItems:"center",minWidth:0,gap:"8px"});this.applyPrintAllRowLayout();this.printButton=$("\n      <div class='printButton title button'>"+getLanguage("frmPrintbtn","Print")+"</div>\n    ");this.printButton.printType="printCurrent";this.analysis=
new AnalysisPrint(this.printButton);this.pictureListForm=new PictureListForm},pickElements:function(a){a.printOnUrl=this.printOnUrl;a.printOffUrl=this.printOffUrl;a.printAll=this.printAll;a.printCurrent=this.printCurrent;a.printRange=this.printRange;a.printButton=this.printButton;a.pictureListForm=this.pictureListForm;this._printFormRef=a;this.refreshPrintAllNoticeVisibility(a)},initEvent:function(a){this.printAll.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));this.printCurrent.click(function(b){this.buttonEvent(a,
b.delegateTarget)}.bind(this));this.printRange.click(function(b){this.buttonEvent(a,b.delegateTarget)}.bind(this));this.printAll.on("click.printNoticeStop mousedown.printNoticeStop touchstart.printNoticeStop pointerdown.printNoticeStop",".print-all-notice",function(b){b.stopPropagation()});this.printRange.find("input").on("input propertychange change",function(){this.refreshPrintButton()}.bind(this));this.printRange.find("input").bind("mousedown touchstart pointerdown mouseover mousemove touchmove touchstend",
function(b){b.stopPropagation()})},buttonEvent:function(a,b){var c=a.stage.find(".on");c.find("img").attr("src",this.printOffUrl);c.find("img")[0].colorChanged=!1;c.removeClass("on");$(b).find("img").attr("src",this.printOnUrl);$(b).find("img")[0].colorChanged=!1;$(b).addClass("on");b=$(b).attr("print");a.printButton.printType=b;this.refreshPrintButton();this.refreshPrintAllNoticeVisibility(a);a.changeItemColor()},refreshPrintButton:function(){"printRange"!=this.printButton.printType||$("#print_range_num").val()?
this.lightPrintButton():this.darkPrintButton()},lightPrintButton:function(){$(this.printButton).addClass("usable");$(this.printButton).removeClass("disable");$(this.printButton).addClass("button_hover")},darkPrintButton:function(){"printRange"==this.printButton.printType&&($(this.printButton).removeClass("usable"),$(this.printButton).removeClass("button_hover"),$(this.printButton).addClass("disable"))},changeLanguage:function(){var a=getLanguage("frmPrintall","Print All Pages"),b=getLanguage("frmPrintcurrent",
"Print Current Pages"),c=getLanguage("frmPrintRange","Print Range");this.printAll.find(".aria-label-title").html(a);this.printAll.find(".title").html(a);this.printCurrent.find(".aria-label-title").html(b);this.printCurrent.find(".title").html(b);this.printRange.find(".aria-label-title").html(c);this.printRange.find(".title").html(c);this.printRange.find("#print_range_num").attr("placeholder",getLanguage("frmPrintexample","Exzample:1,3-7,12"));this.printButton.html(getLanguage("frmPrintbtn","Print"));
this.printAll.find(".print-all-notice-label").text(getLanguage("frmPrintNoticeBtn","Notice"));this.printAllNoticeTooltip&&this.printAllNoticeTooltip.setContent&&this.printAllNoticeTooltip.setContent(getLanguage("frmPrintNoticeTip","This book contains too many pages. Printing all pages at once may cause the browser to crash and prevent successful printing.Please use Print Range to print in batches for better results."))}}).extend(FormElements),PhonePrintElements=Class({create:function(a){this._super(a);
this.printOnUrl=phoneBaseURL+"print_on_phone.png";this.printOffUrl=phoneBaseURL+"print_off_phone.png";this.fontColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.initElements();this.initEvent(a);this.pickElements(a)},initElements:function(){this.rightToLeft?(this.printAll=$("\n        <div class='printAll item button' print='printAll'>\n          <div class='print-all-main'>\n          <span class='title'>"+getLanguage("frmPrintall","Print All Pages")+
...
DownloadService.prototype.buildUrl=function(a,b,c){var d=this,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){return 1==f.nextAddress?(e=d.downloadconfig||{},"downloadAll"===a?f.return(e.pdf&&e.pdf.url?e.pdf.url:""):"downloadCurrent"!==a?f.jumpTo(2):f.yield(getPageDir(b,"normal"),3)):2!=f.nextAddress?f.return(f.yieldResult):"downloadAttachments"===a?f.return(c||""):f.return("")})};
DownloadService.prototype.doDownload=function(a,b,c,d,e,f){var g=this,k,h,l,m,n,p,q,u,t,v;return $jscomp.asyncExecutePromiseGeneratorProgram(function(r){switch(r.nextAddress){case 1:return k={downloadAll:"download_full_publication",downloadCurrent:"download_page_"+b,downloadAttachments:"download_attachment_"+c},"downloadCurrent"===a?BookEvent.trigger("customEvent",[k[a],{downloaded_page:b}]):BookEvent.trigger("customEvent",[k[a]]),r.yield(g.buildUrl(a,b,d),2);case 2:h=r.yieldResult;if("object"===
typeof h){if("downloadCurrent"===a)g._loadImageToCanvas(h,function(w,x){w=x.toDataURL("image/png");g._createAndTriggerDownload(w,"page"+b+".png")});else for(l=0;l<h.length;l++){m=h[l];bookConfig.isEncryptionBook||(m=m.removeStartFrom("?"));if(DownloadService.isWeChatMiniProgramWebView())break;window.open(m,"_blank")}return r.return()}if("string"===typeof h&&-1<h.indexOf(".zip")&&"downloadAttachments"!==a)return g._pdfLoadingTask&&(g._pdfLoadingTask.pause(),g._pdfLoadingTask.destroy()),g._pdfLoadingTask=
new PdfLoadingTask(b,"normal",windowWidth,windowHeight,function(w){g._createAndTriggerDownload(w.toDataURL("image/png"),"page"+b+".png")}),g._pdfLoadingTask.start(),r.return();if(-1<h.indexOf(".js"))return pageResourceLoad(b,"normal",function(w){g._createAndTriggerDownload(w,"page"+b+".png")}),r.return();"downloadCurrent"===a&&isSupportWebp&&!bookConfig.isEncryptionBook&&(h=h.removeStartFrom("?"),-1<h.indexOf("webp")&&(h+="?x-oss-process=image/format,jpg"));if(h.match(/^none/))return n=document.createElement("canvas"),
p=n.getContext("2d"),n.width=bookConfig.largePageWidth,n.height=bookConfig.largePageWidth,p.fillStyle=bookConfig.pageBackgroundColor,p.fillRect(0,0,bookConfig.largePageWidth,bookConfig.largePageHeight),g._createAndTriggerDownload(n.toDataURL("image/png"),"page"+b+".png"),r.return();q="";"downloadCurrent"===a&&(q=b+".jpg");"downloadAttachments"===a&&(q=c||"");if(!location.protocol.match("file:")){r.jumpTo(3);break}/^\/\//i.test(h)&&(h="https://"+h);"English"==UserGroups&&"downloadAll"==a&&(u=window.location.href,
h=h.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(u)));return r.yield(g._tryOpenDownloadInMiniProgram(h,q,a),4);case 4:if(r.yieldResult)return r.return();window.open(h);return r.return();case 3:if("downloadAll"!==a){r.jumpTo(5);break}if(!DownloadService.isWeChatMiniProgramWebView()){r.jumpTo(6);break}return r.yield(g._tryOpenDownloadInMiniProgram(h,q,a),7);case 7:return r.return();case 6:return"English"===UserGroups&&(t=window.location.href,h=h.replace(/bookId=\d+/,"bookUrl="+encodeURIComponent(t))),
bookConfig.isEncryptionBook&&(v=BookRestrict.getRestrictToken(),h=appendParamToUrl(h,"code="+v)),window.open(h,"_blank"),r.return();case 5:if(!(isAndroid()&&isWeChat()||isPad())){r.jumpTo(8);break}return r.yield(g._tryOpenDownloadInMiniProgram(h,q,a),9);case 9:if(r.yieldResult)return r.return();window.open(h,"_blank");return r.return();case 8:if((isPhone()||isPad())&&!_agent_.browser.safari){r.jumpTo(10);break}if(!/fliphtml5|yunzhan365|anyflip|pubhtml5/.test(location.host)){r.jumpTo(10);break}return r.yield(g._tryOpenDownloadInMiniProgram(h,
q,a),12);case 12:if(r.yieldResult)return r.return();g._createAndTriggerDownload(h,q);return r.return();case 10:return r.yield(g._tryOpenDownloadInMiniProgram(h,q,a),13);case 13:if(r.yieldResult)return r.return();new DownloadFile({url:h,downloadName:q,downloadButton:e,downloadingTips:f});r.jumpToEnd()}})};DownloadService.prototype._createAndTriggerDownload=function(a,b,c){a=$('<a href="'+a+'" download="'+b+'" target="'+(void 0===c?"_blank":c)+'"></a>');a[0].click();a.remove()};
DownloadService.prototype._loadImageToCanvas=function(a,b){var c=document.createElement("canvas"),d=c.getContext("2d");c.style.position="relative";c.width=bookConfig.largePageWidth;c.height=bookConfig.largePageHeight;c.style.width=bookConfig.largePageWidth+"px";c.style.height=bookConfig.largePageHeight+"px";Promise.all(a.map(function(e){return new Promise(function(f,g){var k=new Image;k.crossOrigin="Anonymous";k.src=e.replace(/^http:/,"https:");k.onload=function(){f(k)};k.onerror=function(){g(Error("Failed to load image: "+
e))}})})).then(function(e){e.forEach(function(f){var g=f.naturalWidth,k=f.naturalHeight;if(bookConfig.largePageWidth/bookConfig.largePageHeight>g/k){var h=bookConfig.largePageHeight;var l=g/k*h}else l=bookConfig.largePageWidth,h=k/g*l;d.drawImage(f,(bookConfig.largePageWidth-l)/2,(bookConfig.largePageHeight-h)/2,l,h)});b&&b(a,c)}).catch(function(){b&&b(a,c)})};global.DownloadService=DownloadService;
...
DownloadFile.prototype.getBlob=function(a){a=void 0===a?"GET":a;var b=this,c,d,e;return $jscomp.asyncExecutePromiseGeneratorProgram(function(f){switch(f.nextAddress){case 1:return f.setCatchFinallyBlocks(2),f.yield(fetch(b.url,{method:a}),4);case 4:return c=f.yieldResult,c.ok?f.yield(c.blob(),5):f.return("");case 5:return d=f.yieldResult,f.return(d);case 2:return e=f.enterCatchBlock(),console.log("Failed to fetch the file:",e),f.return("")}})};
...
DownloadFile.prototype.setDownloadingText=function(a){var b=this.downloadingTips,c=function(e){switch(e){case "start":return getLanguage("downloadingTips","English"===UserGroups?"Downloading...":"\u6b63\u5728\u4e0b\u8f7d\uff0c\u8bf7\u7a0d\u7b49...");case "success":return getLanguage("downloadSuccessfully","English"===UserGroups?"Download successful!":"\u4e0b\u8f7d\u5b8c\u6210\uff01");case "error":return null;default:return""}},d=function(e){var f=Color(bookConfig.formFontColor?bookConfig.formFontColor:
bookConfig.iconColor).toString();e.css({color:f,margin:"10px 20px"})};if(b.length)this.downloadButton.parent().find(".download-loading-tips").length||this.downloadButton.after(b),(a=c(a))?b.text(a):b.remove();else if(a=c(a))b=$("<div class='download-loading-tips'>"+a+"</div>"),d(b),this.downloadButton.after(b)};
...
c.length)return q.return();d=c.filter(function(u){return"mobile"===u.filter&&!isPC()||"pc"===u.filter&&isPC()?!1:!0});if(!d.length)return b.sharePanel.show(),null==(e=b.codeBox)||e.css({left:"50%",transform:"translateX(-50%)"}),a&&a(!0),q.return();b.loading=$("<img alt='' src=\""+uiBaseURL+'loading.gif" style="position: absolute;left: 0;top: 0;right: 0;bottom: 0;margin: auto;"/>');$(b.sharePanel[0].parentElement.parentElement).append(b.loading);f={};for(g=0;g<d.length;f={$jscomp$loop$prop$obj$9:f.$jscomp$loop$prop$obj$9},
g++)f.$jscomp$loop$prop$obj$9=d[g],k=void 0,f.$jscomp$loop$prop$obj$9.type&&"copy"==f.$jscomp$loop$prop$obj$9.type?(k=$("<a aria-label='"+f.$jscomp$loop$prop$obj$9.title+"' tabindex='0' class='share-item' id='copy_url' data-clipboard-action='copy' title='"+f.$jscomp$loop$prop$obj$9.title+"'>\n            <img alt='' src='"+f.$jscomp$loop$prop$obj$9.logo+"'/>\n          </a>"),copyHref(k[0]),BookEvent.trigger("customEvent",["copy_share_link"])):k=-1<f.$jscomp$loop$prop$obj$9.url.indexOf("javascript")?
$("<a data-type='"+f.$jscomp$loop$prop$obj$9.type+"' aria-label='"+f.$jscomp$loop$prop$obj$9.title+"' tabindex='0' class='share-item' onclick='"+f.$jscomp$loop$prop$obj$9.url.remove("javascript:")+";return false;' title='"+f.$jscomp$loop$prop$obj$9.title+"'>\n            <img alt='' src='"+f.$jscomp$loop$prop$obj$9.logo+"'/>\n          </a>"):$("<a data-type='"+f.$jscomp$loop$prop$obj$9.type+"' aria-label='"+f.$jscomp$loop$prop$obj$9.title+"' tabindex='0' class='share-item' target = '_blank' href='"+
f.$jscomp$loop$prop$obj$9.url+"' title='"+f.$jscomp$loop$prop$obj$9.title+"'>\n            <img alt='' src='"+f.$jscomp$loop$prop$obj$9.logo+"'/>\n          </a>"),b.sharePanel.append(k),b.itemArray.push(k),h=b,k.bind(_event._end,function(u){return function(){var t=$(this).attr("title");BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),t,h.shareCurrentChecked]);t=u.$jscomp$loop$prop$obj$9.type;"share_more"==t&&(t="other_method");"twitter"==t&&(t="x");t&&BookEvent.trigger("customEvent",["click_share_with_"+
t])}}(f));for(m=l=0;m<b.itemArray.length;m++)n=b.itemArray[m],p=n.find("img")[0],p.onload=function(){l++;l==b.itemArray.length&&(b.loading.remove(),b.sharePanel.show(),a&&a())};q.jumpToEnd()})},initEvent:function(a){this.copy1.bind(_event._click,function(){BookEvent.trigger("share",[BookInfo.getCurrentPageIndex(),getLanguage("lblCopy","Copy"),self.shareCurrentChecked]);BookEvent.trigger("customEvent",["copy_share_link"]);this.copyFrom(this.linkArea)}.bind(this));this.linkArea.bind(_event._click,function(){this.linkArea.select()}.bind(this));
...
this.bigShareCode.empty().qrcode({width:160,height:160,render:global.isIE8()?"":"image",text:a})},linkInputChnagedEvent:function(){if(this.linkArea)this.linkArea.on("input propertychange change",function(){var a=this,b,c,d,e,f,g,k;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress)return b=a.linkArea.val(),0<=b.toLowerCase().indexOf("file:")&&(b="index.html"),share_url=b,a.analysisShare.refreshList(),(c=a.analysisShare.shareList)?h.jumpTo(2):h.yield(a.analysisShare.getList(),
3);2!=h.nextAddress&&(c=h.yieldResult);d=c;e={};for(f=0;f<a.itemArray.length;e={$jscomp$loop$prop$type$11:e.$jscomp$loop$prop$type$11},f++)g=a.itemArray[f],e.$jscomp$loop$prop$type$11=g.attr("data-type"),(k=d.find(function(l){return function(m){return m.type===l.$jscomp$loop$prop$type$11}}(e)))&&(-1<k.url.indexOf("javascript")?g.attr("onclick",k.url.remove("javascript:")+";return false;"):g.attr("href",k.url));h.jumpToEnd()})}.bind(this))},copyFrom:function(a){if(a){a.focus();a.select();try{document.execCommand("Copy")}catch(b){a=
...
top:"50%",left:"50%",transform:"translate(-50%, -50%)","-ms-transform":"translate(-50%, -50%)","-moz-transform":"translate(-50%, -50%)","-webkit-transform":"translate(-50%, -50%)",color:"#666","font-size":"12px","pointer-events":"none","z-index":"3",display:"none","white-space":"nowrap"})},onResize:function(){},setImg:function(a,b,c){var d=this,e,f;return $jscomp.asyncExecutePromiseGeneratorProgram(function(g){if(1==g.nextAddress)return d.side=b,d.currentPageIndex=a,c&&"undefined"!==typeof c.pageX&&
"undefined"!==typeof c.pageY&&(d.lastMouseEvent=c),g.yield(getPageDir(a,"normal"),2);e=g.yieldResult;f=Array.isArray(e)?e:[e];d.currentPageSrcs=[];f.forEach(function(k,h){if(k="object"===typeof k&&k?k.url:k){bookConfig.isEncryptionBook||"string"!==typeof k||(k=k.removeStartFrom("?"));this.currentPageSrcs[h]=k;this.config[h]||(this.config[h]={});h=this.config[h];var l=h.loadedSrc===k;l||(h.loadW=0,h.loadH=0,h.showImg=null);h.offset=b.offset();this.isZipSrc(k)?this.prepareZipSource(h,b,c,k,l):this.prepareImageSource(h,
b,c,k,l)}}.bind(d));g.jumpToEnd()})},isZipSrc:function(a){return"string"!==typeof a?!1:-1<a.toLowerCase().indexOf(".zip")},prepareImageSource:function(a,b,c,d,e){a.loadW&&e&&a.showImg?(c=c&&"undefined"!==typeof c.pageX&&"undefined"!==typeof c.pageY?c:this.lastMouseEvent)&&this.beforeDraw(c,a,b):(a.showImg=$('<img alt="" src="'+d+'"/>'),b.css({cursor:"wait"}),this.isImageLoading=!0,a.showImg.on("load",function(){b.css({cursor:"none"});a.loadW=a.showImg[0].naturalWidth;a.loadH=a.showImg[0].naturalHeight;
a.loadedSrc=d;a.offset=b.offset();var f=b.find("img").first();f=0<f.length&&f[0].complete?f:b;this.isImageLoading=!1;var g=this.lastMouseEvent;g&&"undefined"!==typeof g.pageX&&"undefined"!==typeof g.pageY&&this.beforeDraw(g,a,f)}.bind(this)))},prepareZipSource:function(a,b,c,d,e){a.loadW&&e&&a.showImg?(c=this.lastMouseEvent||(c&&"undefined"!==typeof c.pageX&&"undefined"!==typeof c.pageY?c:null))?this.beforeDraw(c,a,b):this.freshWidthAndHeight(a,b):(b.css({cursor:"wait"}),this.isImageLoading=!0,c&&
"undefined"!==typeof c.pageX&&"undefined"!==typeof c.pageY&&(this.lastMouseEvent=c),this.loadPdfCanvasFromZip(d,4*bookConfig.largePageWidth,4*bookConfig.largePageHeight).then(function(f){a.showImg=$(f);a.loadW=f.width;a.loadH=f.height;a.loadedSrc=d;a.offset=b.offset();b.css({cursor:"none"});this.isImageLoading=!1;(f=this.lastMouseEvent)&&"undefined"!==typeof f.pageX&&"undefined"!==typeof f.pageY&&this.beforeDraw(f,a,b)}.bind(this)).catch(function(f){b.css({cursor:"default"});console.error("WindowMagnifier zip render error:",
f)}))},beforeDraw:function(a,b,c){this.freshWidthAndHeight(b,c);this.drawBg(a,b)},freshWidthAndHeight:function(a,b){if(this.side&&(b===this.side||b.jquery&&b.is(this.side)))if(b=this.side.find("img").first(),0<b.length&&b[0].complete){var c=b.width()||b[0].naturalWidth;var d=b.height()||b[0].naturalHeight}else c=this.side.width()||0,d=this.side.height()||0;else b&&b[0]?(c=b.width&&b.width()||b[0].naturalWidth||0,d=b.height&&b.height()||b[0].naturalHeight||0):(c=a.loadW||0,d=a.loadH||0);c&&d||(c=a.loadW||
...
null;a&&"undefined"!==typeof a.pageX&&"undefined"!==typeof a.pageY?this.lastMouseEvent=e=a:this.lastMouseEvent&&(e=this.lastMouseEvent);if(e){a=e.pageX-c/2;var f=e.pageY-d/2;if(this.lastPositionX!==a||this.lastPositionY!==f)this.magnifierZoom.css({left:a+"px",top:f+"px"}),this.lastPositionX=a,this.lastPositionY=f;if(this.currentPageSrcs&&0!==this.currentPageSrcs.length)if(b)a=this.isValidImgConfig(b),f=!1,a&&(f=-1!==this.currentPageSrcs.indexOf(b.loadedSrc)),a&&f?(this.hideLoadingTip(),this.clearMagnifierCanvas(c,
d),this.drawOnceImg(e,b)):this.showLoadingTip();else{var g=!1,k=!1;this.config.forEach(function(h,l){this.isValidImgConfig(h,l)&&this.isImgConfigMatched(h,l)&&(g=!0,this.hideLoadingTip(),k||(this.clearMagnifierCanvas(c,d),k=!0),this.drawOnceImg(e,h))}.bind(this));g||this.showLoadingTip()}else this.showLoadingTip()}else this.ctx.clearRect(0,0,c,d),this.showLoadingTip()},isValidImgConfig:function(a,b){if(!a||!a.showImg||"undefined"!==typeof b&&0<this.currentPageSrcs.length&&(b=this.currentPageSrcs[b])&&
...
"undefined"!==typeof b.rateH&&a&&"undefined"!==typeof a.pageX&&"undefined"!==typeof a.pageY&&(this.hideLoadingTip(),this.drawImg(b.showImg,(a.pageX-b.offset.left-this.magnifierW/2)*b.rateW,(a.pageY-b.offset.top-this.magnifierH/2)*b.rateH,b.rateW*this.magnifierW,b.rateH*this.magnifierH,this.drawW,this.drawH))},clearMagnifierCanvas:function(a,b){this.ctx.clearRect(0,0,a,b)},drawImg:function(a,b,c,d,e,f,g){if(a){if(a[0])a=a[0];else if(!a.nodeType){console.warn("WindowMagnifier: invalid img element",
a);return}if(!a||"IMG"===a.tagName&&!a.complete)console.warn("WindowMagnifier: img element is not ready",a);else if(!(0>=d||0>=e||0>=f||0>=g)){if(this.lastContainerWidth!==f||this.lastContainerHeight!==g)this.magnifierZoom.css({width:f+"px",height:g+"px"}),this.lastContainerWidth=f,this.lastContainerHeight=g;var k="IMG"===a.tagName?a.naturalWidth:a.width,h="IMG"===a.tagName?a.naturalHeight:a.height;if(k&&h){var l=Math.max(0,b),m=Math.max(0,c);k=Math.min(k,b+d)-l;h=Math.min(h,c+e)-m;if(!(0>=k||0>=
h))try{this.ctx.drawImage(a,l,m,k,h,(l-b)/d*f,(m-c)/e*g,k/d*f,h/e*g)}catch(n){console.error("WindowMagnifier: drawImage error",n)}}}}else console.warn("WindowMagnifier: img is undefined")},getRenderTargetSize:function(a){var b=a&&a.width?a.width():0;a=a&&a.height?a.height():0;if(!(b&&a||"undefined"===typeof BookInfo)&&BookInfo.getBook){var c=BookInfo.getBook();c&&(!b&&c.pageWidth&&(b=c.pageWidth),!a&&c.pageHeight&&(a=c.pageHeight))}b||(b=this.magnifierW*this.maxScale);a||(a=this.magnifierH*this.maxScale);
return{width:b,height:a}},loadPdfCanvasFromZip:function(a,b,c){return new Promise(function(d,e){"undefined"===typeof pdfjsLib?e(Error("pdfjsLib not loaded")):"function"!==typeof getBlob?e(Error("getBlob not available")):getBlob(a).then(function(f){pdfjsLib.getDocument({url:f.url,cMapUrl:window.cMapUrl,cMapPacked:!0,password:f.password}).promise.then(function(g){g.getPage(1).then(function(k){this.renderPdfPageToCanvas(k,b,c).then(d).catch(e)}.bind(this)).catch(e)}.bind(this)).catch(e)}.bind(this)).catch(e)}.bind(this))},
renderPdfPageToCanvas:function(a,b,c){return new Promise(function(d,e){try{var f=document.createElement("canvas"),g=f.getContext("2d"),k=window.devicePixelRatio||1,h=a.getViewport({scale:1}),l=fitPageWidthHeight(b||h.width,c||h.height,h.width,h.height).x/h.width;h=a.getViewport({scale:l});var m=h.width,n=h.height;f.width=m*k;f.height=n*k;f.style.width=m+"px";f.style.height=n+"px";a.render({canvasContext:g,transform:1!==k?[k,0,0,k,0,0]:null,viewport:h}).promise.then(function(){d(f)}).catch(e)}catch(p){e(p)}})},
...
this.initElements();this.initEvent(a);this.pickElements(a)},checkConfig:function(){for(var a=function(d){if(d&&d.children&&0!=d.children.length)for(var e=d.children.length,f=0;f<e;f++)d.children[f].level=parseInt(d.children[f].level)+1,a(d.children[f])},b=ols.length,c=0;c<b;c++)0==parseInt(ols[c].level)&&(ols[c].level=parseInt(ols[c].level)+1,a(ols[c]))},initElements:function(){this.searchButtonUrl=form_icons.search_form?"data:image/png;base64,"+form_icons.search_form:uiBaseURL+"search_form.png";
...
[],c=function(d){for(var e=[],f=0;f<d.length;f++){var g={caption:d[f].caption,page:d[f].page,level:d[f].level,url:d[f].url};d[f].children&&0<d[f].children.length&&(g.children=c(d[f].children));if(0<=d[f].caption.toLowerCase().indexOf(a))e.push(g);else if(g.children&&0<g.children.length)for(var k=0;k<g.children.length;k++)e.push(g.children[k])}return e};return b=c(ols)},pickElements:function(a){a.input=this.input;a.searchButton=this.searchButton;a.result=this.result;a.searchButtonUrl=this.searchButtonUrl;
...
var Tooltip=Class({create:function(a){this.options=$.extend({target:null,content:"",placement:"bottom",trigger:"hover",showArrow:!0,delay:0,hideDelay:0,disabled:!1,zIndex:10001,wrapContent:!1,contentMaxWidth:null,boundary:null,boundaryPadding:0},a);this.visible=!1;this.timer=null;this.target=this.options.target;this.tooltip=null;this.init()},init:function(){this.createTooltip();this.bindEvents()},createTooltip:function(){this.tooltip=$('<div class="tooltip-container"></div>');this.tooltip.css({position:"absolute",
zIndex:this.options.zIndex,display:"none",pointerEvents:"none"});var a=$('<div class="tooltip-content"></div>');a.html(this.options.content);a.css({background:"rgba(0, 0, 0, 0.8)",color:"#fff",padding:"10px",borderRadius:"4px",fontSize:"14px",lineHeight:"1.4",maxWidth:null!=this.options.contentMaxWidth?this.options.contentMaxWidth:this.options.wrapContent?"280px":"200px",wordWrap:"break-word",whiteSpace:this.options.wrapContent?"normal":"nowrap"});this.tooltip.append(a);this.options.showArrow&&(a=
$('<div class="tooltip-arrow"></div>'),a.css({position:"absolute",width:"0",height:"0",border:"4px solid transparent"}),this.tooltip.append(a));$("body").append(this.tooltip)},bindEvents:function(){var a=this;"hover"===this.options.trigger?(this.target.on("mouseenter",function(){a.options.disabled||(clearTimeout(a.timer),a.timer=setTimeout(function(){a.show()},a.options.delay))}),this.target.on("mouseleave",function(){clearTimeout(a.timer);a.timer=setTimeout(function(){a.hide()},a.options.hideDelay)})):
"click"===this.options.trigger&&(this.target.on("click",function(b){b.preventDefault();a.options.disabled||(a.visible?a.hide():a.show())}),a._documentClickHandler=function(b){$(b.target).closest(a.target).length||$(b.target).closest(a.tooltip).length||a.hide()},$(document).on("click",a._documentClickHandler))},show:function(){this.visible||this.options.disabled||(this.visible=!0,this.tooltip.show(),this.updatePosition())},hide:function(){this.visible&&(this.visible=!1,this.tooltip.hide())},getBoundaryRect:function(){var a=
"number"===typeof this.options.boundaryPadding?this.options.boundaryPadding:0;if(this.options.boundary&&$(this.options.boundary).length){var b=$(this.options.boundary),c=b.offset(),d=b.outerWidth();b=b.outerHeight();a={left:c.left+a,top:c.top+a,right:c.left+d-a,bottom:c.top+b-a}}else c=$(window),d=c.scrollLeft(),b=c.scrollTop(),a={left:d+a,top:b+a,right:d+c.width()-a,bottom:b+c.height()-a};a.right<a.left&&(a.right=a.left);a.bottom<a.top&&(a.bottom=a.top);return a},_rectFullyInside:function(a,b,c,
d,e){return a>=e.left&&b>=e.top&&a+c<=e.right&&b+d<=e.bottom},_intersectionArea:function(a,b,c,d,e){var f=Math.max(a,e.left),g=Math.max(b,e.top);a=Math.min(a+c,e.right);b=Math.min(b+d,e.bottom);return a<=f||b<=g?0:(a-f)*(b-g)},_clampTooltipPosition:function(a,b,c,d,e){var f=e.bottom-e.top;c<=e.right-e.left?a<e.left?a=e.left:a+c>e.right&&(a=e.right-c):a=e.left;d<=f?b<e.top?b=e.top:b+d>e.bottom&&(b=e.bottom-d):b=e.top;return{left:a,top:b}},_computePositionForPlacement:function(a,b,c,d,e,f,g){var k=
{top:0,left:0};switch(a){case "top":k.top=b.top-f-g;k.left=b.left+(c-e)/2;break;case "bottom":k.top=b.top+d+g;k.left=b.left+(c-e)/2;break;case "left":k.top=b.top+(d-f)/2;k.left=b.left-e-g;break;case "right":k.top=b.top+(d-f)/2;k.left=b.left+c+g;break;default:k.top=b.top+d+g,k.left=b.left+(c-e)/2}return k},updatePosition:function(){function a(u){return l._computePositionForPlacement(u,b,c,d,e,f,g)}if(this.target&&this.tooltip){var b=this.target.offset(),c=this.target.outerWidth(),d=this.target.outerHeight(),
e=this.tooltip.outerWidth(),f=this.tooltip.outerHeight(),g=this.options.showArrow?8:0,k=this.getBoundaryRect(),h=this.options.placement,l=this,m=h;if("top"===h||"bottom"===h){m="top"===h?"bottom":"top";var n=a(h),p=a(m);if(l._rectFullyInside(n.left,n.top,e,f,k))m=h,h=n;else if(l._rectFullyInside(p.left,p.top,e,f,k))h=p;else{var q=l._intersectionArea(n.left,n.top,e,f,k);l._intersectionArea(p.left,p.top,e,f,k)>q?h=p:(m=h,h=n)}}else"left"===h||"right"===h?(m="left"===h?"right":"left",n=a(h),p=a(m),l._rectFullyInside(n.left,
n.top,e,f,k)?(m=h,h=n):l._rectFullyInside(p.left,p.top,e,f,k)?h=p:(q=l._intersectionArea(n.left,n.top,e,f,k),l._intersectionArea(p.left,p.top,e,f,k)>q?h=p:(m=h,h=n))):(h=a("bottom"),m="bottom");k=l._clampTooltipPosition(h.left,h.top,e,f,k);this._effectivePlacement=m;this.tooltip.css({top:k.top+"px",left:k.left+"px"});this.updateArrow(k)}},updateArrow:function(a){if(this.options.showArrow){a=this.tooltip.find(".tooltip-arrow");var b=null!=this._effectivePlacement?this._effectivePlacement:this.options.placement;
a.css({position:"absolute",width:"0",height:"0",border:"4px solid transparent"});switch(b){case "top":a.css({top:"100%",left:"50%",marginLeft:"-4px",borderTopColor:"rgba(0, 0, 0, 0.8)",borderBottom:"none"});break;case "bottom":a.css({bottom:"100%",left:"50%",marginLeft:"-4px",borderBottomColor:"rgba(0, 0, 0, 0.8)",borderTop:"none"});break;case "left":a.css({top:"50%",left:"100%",marginTop:"-4px",borderLeftColor:"rgba(0, 0, 0, 0.8)",borderRight:"none"});break;case "right":a.css({top:"50%",right:"100%",
marginTop:"-4px",borderRightColor:"rgba(0, 0, 0, 0.8)",borderLeft:"none"})}}},setContent:function(a){this.options.content=a;var b=this.tooltip.find(".tooltip-content");b.html(a);b.css({maxWidth:null!=this.options.contentMaxWidth?this.options.contentMaxWidth:this.options.wrapContent?"280px":"200px",whiteSpace:this.options.wrapContent?"normal":"nowrap"})},setTarget:function(a){this.target=$(a);this.bindEvents()},destroy:function(){this._documentClickHandler&&($(document).off("click",this._documentClickHandler),
this._documentClickHandler=null);this.tooltip&&this.tooltip.remove();this.timer&&clearTimeout(this.timer)}});global.createTooltip=function(a){return new Tooltip(a)};var PcAboutForm=Class({create:function(a){this.parent=a.parent;this.visible=!0;this.mainColor=bookConfig.formBackgroundColor?bookConfig.formBackgroundColor:bookConfig.toolbarColor;this.fontColor=bookConfig.formFontColor?bookConfig.formFontColor:bookConfig.iconColor;decodeAboutInfo();this.initHtml();this.initEvent();this.bookReadTimesVisible()},initHtml:function(){this.stage=$("<div class='about_form' style='display:none;'></div>");this.arrow=$("<div class='arrow' ></div>");this.logo=$("<a class='logo' target='_blank' style='display:none;background:url("+
...
b[c]+" 63%)"}));(function(e,f,g){f.bind("click",function(){e.resetColor(e.colorOrder);f.addClass("active");e.setElemColor(g);f.css({"background-image":"radial-gradient("+g+" 40%, transparent 48%, transparent 53%,"+g+" 63%)"})}.bind(e))})(this,d,b[c]);this.colorOrder.append(d)}a.append(this.colorOrder);this.colorSelection.bind(_event._click,function(){this.resetColor()}.bind(this))},onResize:function(){this._super();var a=windowHeight;this.stage.find(".bookmark_content").css({height:a-87+"px"});toolBar.getTopHeight();
...
g.nextAddress)return g.yield(b.elements.analysisShare.getList(),2);c=g.yieldResult;if(!c||0>c.length)return g.return();for(d=0;d<c.length;d++)e=c[d],f=void 0,f=-1<e.url.indexOf("javascript")?$("<a data-type='"+e.type+"' target = '_blank' href='#' onclick='"+e.url.remove("javascript:")+";return false;' title='"+e.title+"'><img src='"+e.logo+"'/></a>"):$("<a data-type='"+e.type+"' target = '_blank' href='"+e.url+"' title='"+e.title+"'><img src='"+e.logo+"'/></a>"),b.sharePanel.append(f),b.itemArray.push(f);
