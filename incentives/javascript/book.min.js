...
function mergeCurrentPageIntoUrlHash(b){if(!b||"undefined"===typeof BookInfo||!BookInfo.getCurrentPageIndex)return b;var c=BookInfo.getCurrentPageIndex(),d="function"===typeof getShownPageNumber?getShownPageNumber(c):c;if(void 0===d||null===d)d=c;d=String(d);var e=b.indexOf("#");c=0<=e?b.slice(0,e):b;b=0<=e?b.slice(e+1):"";b=b.length?b.split("&"):[];e=[];for(var f=0;f<b.length;f++)/^p=/i.test(b[f])||e.push(b[f]);b=e.join("&");return c+"#"+(b.length?"p="+d+"&"+b:"p="+d)}
...
getConfigValue("power_info","");tmpBookConfig.power_info&&"string"===typeof tmpBookConfig.power_info&&(tmpBookConfig.power_info=JSON.parse(tmpBookConfig.power_info));tmpBookConfig.clickBlankToFlip=getConfigValue("clickBlankToFlip",!0);tmpBookConfig.PageModeButtonVisible=getConfigValue("PageModeButtonVisible",!1);tmpBookConfig.isAnnotationCustomIconEnabled=getConfigValue("isAnnotationCustomIconEnabled",!1);tmpBookConfig.annotationStickerButtonIcon=getConfigValue("annotationStickerButtonIcon","");tmpBookConfig.annotationAddTextButtonIcon=
getConfigValue("annotationAddTextButtonIcon","");tmpBookConfig.annotationSelectTextButtonIcon=getConfigValue("annotationSelectTextButtonIcon","");tmpBookConfig.annotationBrushButtonIcon=getConfigValue("annotationBrushButtonIcon","");tmpBookConfig.annotationHighlighterButtonIcon=getConfigValue("annotationHighlighterButtonIcon","");tmpBookConfig.annotationRectangleButtonIcon=getConfigValue("annotationRectangleButtonIcon","");tmpBookConfig.annotationEllipseButtonIcon=getConfigValue("annotationEllipseButtonIcon",
"");tmpBookConfig.annotationEraserButtonIcon=getConfigValue("annotationEraserButtonIcon","");tmpBookConfig.annotationClearButtonIcon=getConfigValue("annotationClearButtonIcon","");tmpBookConfig.annotationUndoButtonIcon=getConfigValue("annotationUndoButtonIcon","");tmpBookConfig.annotationRedoButtonIcon=getConfigValue("annotationRedoButtonIcon","");tmpBookConfig.annotationSaveButtonIcon=getConfigValue("annotationSaveButtonIcon","");tmpBookConfig.annotationExitButtonIcon=getConfigValue("annotationExitButtonIcon",
"");tmpBookConfig.homeButtonDestinationType=getConfigValue("homeButtonDestinationType","").toLowerCase();tmpBookConfig.isShowBottomFullscreenPrompts=getConfigValue("isShowBottomFullscreenPrompts",!0);tmpBookConfig.isMobileFirstLastShortcutVisible=getConfigValue("isMobileFirstLastShortcutVisible",void 0);void 0!==tmpBookConfig.isMobileFirstLastShortcutVisible&&(tmpBookConfig.isMobileFirstLastShortcutVisible=parseBool(tmpBookConfig.isMobileFirstLastShortcutVisible));tmpBookConfig.isMobilePageBackButtonVisible=
...
this,g;return $jscomp.asyncExecutePromiseGeneratorProgram(function(h){if(1==h.nextAddress){if(!b||0>b||b>bookConfig.totalPageCount)return e(),h.return();if(f.page)return f.loaded=!0,f.renderCanvas(f.pageWidth,f.pageHeight).then(function(k){this.callback&&this.callback(k);this.rendered=!0;d(k)}.bind(f)),h.return();f.loadingTask&&(f.loadingTask.destroy(),f.loadingTask=null);return h.yield(getPageDir(b,c,originTotalPageCount),2)}g=h.yieldResult;"object"==typeof g&&(g=g[0]);getBlob(g).then(function(k){this.loadingTask=
pdfjsLib.getDocument({url:k.url,cMapUrl:window.cMapUrl,cMapPacked:!0,password:k.password});this.loadingTask.promise.then(function(l){l.getPage(1).then(function(m){this.loaded=!0;this.page=m;this.renderCanvas(this.pageWidth,this.pageHeight).then(function(q){this.rendered=!0;this.callback&&this.callback(q);d(q)}.bind(this))}.bind(this))}.bind(this))}.bind(f));h.jumpToEnd()})}.bind(this))},renderCanvas:function(b,c){this.rendered=!1;return new Promise(function(d,e){this.renderWidth=b;this.renderHeight=
c;this.renderTask&&(this.renderTask.cancel(),this.renderTask=null);var f=$("<canvas><canvas/>")[0],g=f.getContext("2d"),h=window.devicePixelRatio||1,k=this.page,l=k.getViewport({scale:1});l=fitPageWidthHeight(b,c,l.width,l.height).x/l.width;l=k.getViewport({scale:l});var m=l.width,q=l.height;isPC()||(m>q?3E3<m*h&&(h=3E3/m):3E3<q*h&&(h=3E3/q));f.width=m*h;f.height=q*h;1==h?(f.style.width=f.width+"px",f.style.height=f.height+"px"):(f.style.width=m+"px",f.style.height=q+"px");g={canvasContext:g,transform:1!==
...
this.renderTask&&(this.renderTask.cancel(),this.renderTask=null,this.rendered=!1)},enterSide:function(){},leaveSide:function(){},changeRenderWH:function(b,c){if(this.pageWidth!=b||this.pageHeight!=c)this.pageWidth=b,this.pageHeight=c,this.rendered=!1}});window.pdfPages={normal:[],thumb:[],large:[]};
...
g.split("-");if(Number.isBetween(d,parseInt(h[0]),parseInt(h[1]))){var k=!1;break a}}else if(d==parseInt(g)){k=!1;break a}}}catch(l){}k=!0}k?BookRestrict.unLimitPages[c]="restrict":BookRestrict.unLimitPages[c]="open"}}catch(l){}}}}),WatermarkCore=function(b){this.canvas=b;this.ctx=b.getContext("2d");this.observer=null};
...
bookConfig.addCurrentPage&&(global.sharePanel&&global.sharePanel.elements&&global.sharePanel.elements.fillArea(!0,"link"),window.refreshWeixinShareWithCurrentBookMeta&&window.refreshWeixinShareWithCurrentBookMeta());global.downLoadBody&&downLoadBody.gotoPage(b);if(bookConfig.AnnotationButtonVisible&&!isPhone()&&!isPad()&&BookInfo.getBook().bookAttachments.noteAdd)BookInfo.getBook().bookAttachments.noteAdd.onResize();setCurrentIndexTextField(BookInfo.getCurrentPageIndex(),BookInfo.isDoublePage());
