...
link:g,imgUrl:h,success:function(){},cancel:function(){}});wx.onMenuShareAppMessage({title:e,desc:f,link:g,imgUrl:h,success:function(){},cancel:function(){}});wx.onMenuShareQQ({title:e,desc:f,link:g,imgUrl:h,success:function(){},cancel:function(){}});wx.onMenuShareWeibo({title:e,desc:f,link:g,imgUrl:h,success:function(){},cancel:function(){}});try{wx.onMenuShareWechat({title:e,desc:f,link:g,imgUrl:h,success:function(){},cancel:function(){}})}catch(k){}wx.invoke("shareAppMessage",{title:e,desc:f,link:g,
imgUrl:h},function(k){});wx.invoke("shareWechatMessage",{title:e,desc:f,link:g,imgUrl:h},function(k){});wx.invoke("shareToExternalContact",{title:e,desc:f,link:g,imgUrl:h},function(k){});wx.invoke("shareToExternalChat",{title:e,desc:f,link:g,imgUrl:h},function(k){})});wx.error(function(k){})}}
