...
n=2*e,p=2*g;"object"!=typeof m&&m.match(/none/)?b.getPrintImgType(l.$jscomp$loop$prop$page$7).then(function(q){pageResourceLoad(l.$jscomp$loop$prop$page$7,q,d.bind(b),n,p)}):pageResourceLoad(l.$jscomp$loop$prop$page$7,"normal",d.bind(b),n,p)}}(f));h.jumpToEnd()})},createCompositeImage:function(a,b){var c=this;return new Promise(function(d,e){try{var g=document.createElement("canvas"),f=g.getContext("2d"),k=new Image;k.crossOrigin="anonymous";k.onload=function(){var h,l,m,n;return $jscomp.asyncExecutePromiseGeneratorProgram(function(p){if(1==
...
var a=bookConfig.socialShareLink?bookConfig.socialShareLink:bookConfig.addCurrentPage?window.location.href:window.location.href.removeStartFrom("#p=");this.qrcodeBox.qrcode({width:100,height:100,render:"image",text:a});this.pContainer.append(this.canvas).append(this.svg)},initPosterImg:function(){this.beforeCreatePoster();this.canvas[0].width=684;this.canvas[0].height=1036;this.imgs=[this.cvsBg,this.thumb];this.getSrcAndImg(0)},setImgs:function(a,b){var c=a.imgs;a.loadImgFun(c[b]).then(function(){b+=
1;b<c.length?a.setImgs(a,b):a.drawPoster()})},isBgSvg:function(a){return"object"==typeof a&&(a[0]&&-1<a[0].indexOf("svg")||a[1]&&-1<a[1].indexOf("svg"))},getSrcAndImg:function(a){var b=this;getPageDir(1,"normal").then(function(c){b.isBgSvg(c)?(c.forEach(function(d,e){bookConfig.isEncryptionBook||(d=d.removeStartFrom("?"));d.match(/.jpg|.png|.webp/)?(this.thumb.attr("src",d),this.thumb.attr("crossOrigin","Anonymous")):(e=$("<img />"),e.attr("src",d),e.attr("crossOrigin","Anonymous"),this.imgs.push(e))}.bind(b)),
b.setImgs(b,a)):("object"==typeof c&&c[0]&&(c=(fliphtml5_pages.normalPath&&void 0!=fliphtml5_pages.normalPath[0]?fliphtml5_pages.normalPath[0]:"")+c[0]),-1<c.indexOf("none")?getPageDir(1,"thumb").then(function(d){d.match(/none/)?(b.thumb.attr("src","").css({display:"none"}),b.setImgs(b,a)):(bookConfig.isEncryptionBook||(d=d.removeStartFrom("?")),b.thumb.attr("src",d),b.thumb.attr("crossOrigin","Anonymous"),b.setImgs(b,a),b.isUseThumb=!0)}):"string"==typeof c&&c.match(/.jpg|.png|.webp/)?(bookConfig.isEncryptionBook||
(c=c.removeStartFrom("?")),b.thumb.attr("src",c),b.thumb.attr("crossOrigin","Anonymous"),b.setImgs(b,a)):"string"==typeof c&&-1<c.indexOf(".zip")&&(b.pdfLoadingTask=new PdfLoadingTask(1,"normal",684,1036,b.afterLoadPdf.bind(b,a)),b.pdfLoadingTask.start()))})},afterLoadPdf:function(a,b){this.thumb.attr("src",b.toDataURL("image/png"));this.setImgs(this,a)},loadImgFun:function(a){var b=$(a);return new Promise(function(c,d){b[0].complete?(console.log("load img complete"),b.attr("crossOrigin","Anonymous"),
c()):(b[0].onload=function(){b.attr("crossOrigin","Anonymous");console.log("load img ok");c()},b[0].onerror=function(e){console.log("load img error",b);d(e)})}.bind(this))},drawImages:function(a,b){this.imgs.shift();this.imgs.forEach(function(c){var d=getImageConfig(c[0],556,781,this.isUseThumb);""===c.attr("src")?(d={width:556,height:781,left:0,top:0},this.ctx.fillStyle="#ffffff",this.ctx.fillRect(a+d.left,b+d.top,d.width,d.height)):this.ctx.drawImage(c[0],d.left+a,d.top+b,d.width,d.height)}.bind(this))},
drawPoster:function(){var a=window.document.title,b=getImageConfig(this.thumb[0],556,781,this.isUseThumb);if(!this.thumb[0].src.match(/base64/)&&-1<this.thumb[0].src.indexOf("none")||!this.thumb[0].src.match(/jpg|png|webp/))b={width:556,height:781,left:0,top:0};this.ctx.drawImage(this.cvsBg[0],0,0,684,1036);this.drawBottomShadow(b,64,55);this.drawImages(64,55);this.drawCvsBorder(b,64,55);this.drawLeftShadow(b,64,55);this.drawTitleText(a,"20 Arial");this.ctx.fillStyle="#ffffff";this.ctx.fillRect(308,
936,1,60);this.drawAlertText();this.drawQrcode();try{this.afterCreatedPoster();var c=this.canvas[0].toDataURL("image/png",1);this.posterImg.attr("src",c);isIE()?this.pcDownload.bind("click",function(){if(navigator.msSaveBlob)return navigator.msSaveBlob(this.getDataURLtoBlob(c),"poster.png")}.bind(this)):(this.pcDownload.attr("href",c),this.pcDownload.attr("download","poster"));this.hasPoster=!0}catch(d){this.isloadFail=!0,this.afterFailLoad(),console.log(d)}},getDataURLtoBlob:function(a){var b=a.split(",");
a=b[0].match(/:(.*?);/)[1];b=atob(b[1]);for(var c=b.length,d=new Uint8Array(c);c--;)d[c]=b.charCodeAt(c);return new Blob([d],{type:a})},drawBottomShadow:function(a,b,c){this.ctx.save();this.ctx.shadowBlur=40;this.ctx.shadowColor="rgba(11,11,11,0.7)";this.ctx.fillStyle="#ffffff";this.ctx.shadowOffsetY=20;this.ctx.fillRect(a.left+b+.03*a.width,c+a.top+a.height-147,.94*a.width,146);this.ctx.restore()},drawLeftShadow:function(a,b,c){this.ctx.save();if(rightToLeft){var d=this.ctx.createLinearGradient(a.left+
b+a.width-8,c+a.top+a.height-a.height,a.left+b+a.width,c+a.top+a.height-a.height);d.addColorStop(0,"rgba(255,255,255,0)");d.addColorStop(1,"rgba(58,58,58,0.8)")}else d=this.ctx.createLinearGradient(a.left+b,c+a.top+a.height-a.height,a.left+b+8,c+a.top+a.height-a.height),d.addColorStop(0,"rgba(58,58,58,0.8)"),d.addColorStop(1,"rgba(255,255,255,0)");this.ctx.fillStyle=d;this.ctx.fillRect(a.left+b+a.width-8,c+a.top+a.height-a.height,8,a.height);this.ctx.restore()},drawCvsBorder:function(a,b,c){for(var d=
a.height,e=0;5>e;e++)this.ctx.fillStyle=0==e%2?"#e5e5e5":"#f2f2f2",rightToLeft?this.ctx.fillRect(Math.floor(a.left+b-5+1*e),c+a.top+(5-e),1,d-2*(5-e)):this.ctx.fillRect(Math.floor(a.left+b+a.width+1*e),c+a.top+1*e,1,d-2*e)},drawTitleText:function(a,b){b&&(this.ctx.font="20px Arial");var c=this.ctx.measureText(a).width;b=957;this.ctx.textBaseline="top";274<c?(b=943,c=this.getLinitText(a,274),a=this.getLinitText(a.replace(c,""),266,!0),this.ctx.fillText(c,15,b),this.ctx.fillText(a,15,b+26)):this.ctx.fillText(a,
15+(274-c)/2,b)},getLinitText:function(a,b,c){var d="",e="";textArr=a;for(a=0;a<textArr.length;a++){if(this.ctx.measureText(d).width>b)return c?e+"...":e;e=d;d+=textArr[a]}return d},drawAlertText:function(){this.ctx.font="20px Arial";var a=954;this.ctx.textBaseline="top";this.ctx.fillStyle="#db9a67";var b=this.getLinitText(getLanguage("infLongPressToIndentify","Long press to identify QR code"),267,!0),c=this.getLinitText(getLanguage("infScanCodeToView","Scan code to read"),227,!0),d=323+(226-this.ctx.measureText(c).width)/
2;if(getLanguage("infLongPressToIndentify")){a=943;this.ctx.font="14px Arial";var e=323+(226-this.ctx.measureText(b).width)/2;this.ctx.fillText(b,e,a);this.ctx.font="20px Arial";this.ctx.fillText(c,d,a+26)}else this.ctx.fillText(c,323,a)},drawQrcode:function(){this.ctx.fillStyle="#ffffff";this.ctx.fillRect(561,911,110,110);this.ctx.drawImage(this.qrcodeBox.find("img")[0],566,916,100,100);var a=new Image;a.src=bookConfig.appLogoIcon;a.setAttribute("crossOrigin","Anonymous");bookConfig.appLogoIcon&&
this.ctx.drawImage(a,611,961,20,20)},getCloseSrc:function(){return"./style/icon/close.svg"},initPosterImgPanel:function(){this.topTitle=$("<div style='transition:transform 0.3s;-webkit-transition:transform 0.3s;-webkit-transform:translateY(-30px);transform:translateY(-30px);font-size:14px;color:#fff;width:100%;position:absolute;top:0;left:0;height:28px;background:rgba(11,11,11,0.5) '></div>");this.pcDownload=$("<a style='position:absolute;padding-left:24px;left:6px;color:#fff;text-decoration:none;line-height:28px;height:28px;cursor:pointer;'><span style='position:absolute;left:0;width:20px;height:20px;top:4px;background: url("+
...
a.linkArea.val(),0<=b.toLowerCase().indexOf("file:")&&(b="index.html"),c="<iframe frameborder='0'  width='240' height='210'  title='"+window.document.title+"' src='"+b+"' type='text/html' allowfullscreen='true' scrolling='no' marginwidth='0' marginheight='0'></iframe>",a.insertArea&&a.insertArea.val(c),share_url=b,a.analysisShare.refreshList(),h.yield(a.analysisShare.getList(),2);d=h.yieldResult;e={};for(g=0;g<a.itemArray.length;e={$jscomp$loop$prop$type$13:e.$jscomp$loop$prop$type$13},g++)f=a.itemArray[g],
e.$jscomp$loop$prop$type$13=f.attr("data-type"),(k=d.find(function(l){return function(m){return m.type===l.$jscomp$loop$prop$type$13}}(e)))&&(-1<k.url.indexOf("javascript")?f.attr("onclick",k.url.remove("javascript:")+";return false;"):f.attr("href",k.url));h.jumpToEnd()})}.bind(this))},copyFrom:function(a){if(a){a.focus();a.select();try{document.execCommand("Copy")}catch(b){a=a.val(),copyToClipboard(a)}}},changeLanguage:function(){this.copy1.html(getLanguage("lblCopy","Copy"))},initColorConfig:function(){this.mainColor=
